 ...
 *
 *
 *  102: class tx_caddy_paymill_paymentMethods extends tslib_pibase
 *
 *              SECTION: Main
 *  148:     public function main( $paymentId=null, $pid=null )
 *
 *              SECTION: Init
 *  211:     private function init( $paymentId=null, $pid=null )
 *  228:     private function initDrs( )
 *  241:     private function initInstances( )
 *  269:     private function initPaymillLib( )
 *  290:     private function initVarsPid( $pid=null )
 *  326:     private function initVars( $paymentId, $pid )
 *
 *              SECTION: Payment Methods
 *  357:     private function paymentMethods( )
 *  414:     private function paymentMethodsCreditcard( )
 *  443:     private function paymentMethodsElv( )
 *  465:     private function paymentMethodsElvIban( )
 *  489:     private function paymentMethodsUndefined( )
 *  503:     private function paymentWiPowermail( )
 *
 *              SECTION: Powermail
 *  524:     private function powermailInAction( )
 *
 *              SECTION: Requirements
 *  561:     private function requirements( )
 *  587:     private function requirementsDie( )
 *  607:     private function requirementsToken( )
 *  643:     private function requirementsWiPowermail( )
 *
 *              SECTION: Prompts
 *  674:     private function serverPrompt( )
 *
 *              SECTION: Session
 *  716:     private function session( )
 *  747:     private function sessionDataAdd( )
 *  772:     private function sessionDataRemove( $force=false )
 *  820:     private function sessionGetToken( )
 *
 *              SECTION: Setting methods
 *  845:     public function setParentObject( $pObj )
 *
 *              SECTION: Template
 *  894:     private function template( $subpart )
 *  981:     private function templateMode( )
 * 1007:     private function templateModeLive( )
 * 1021:     private function templateModeTest( )
 * 1045:     private function templateModeTestData( )
 * 1069:     private function templateModeTestDataCreditcard( )
 * 1090:     private function templateModeTestDataElv( )
 * 1109:     private function templateModeTestDataElvIban( )
 * 1128:     private function templateModeTestDataWiPowermail( )
 * 1142:     private function templateSectionActive( $template )
 *
 * TOTAL FUNCTIONS: 34
