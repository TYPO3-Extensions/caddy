...
switch ( true )
{
  case( $beLanguage == 'de' ):
    ...
    t3lib_extMgm::addStaticFile( $_EXTKEY, $path2Ts . 'Foundation/5x/', 'Caddy [3] + Foundation 5.x' );
    t3lib_extMgm::addStaticFile( $_EXTKEY, $path2Ts . 'Foundation/4x/', 'Caddy [3] + Foundation 4.x (veraltet!)' );
    t3lib_extMgm::addStaticFile( $_EXTKEY, $path2Ts . 'Foundation/5x/Css/', 'Caddy [3.1] + Foundation 5.x CSS' );
...
switch ( true )
{
  case( $beLanguage == 'de' ):
    // German
    $TCA[ 'pages' ][ 'columns' ][ 'module' ][ 'config' ][ 'items' ][] = array( 'Caddy', 'caddy', t3lib_extMgm::extRelPath( $_EXTKEY ) . 'files/img/caddy_100_02.png' );
    $TCA[ 'pages' ][ 'columns' ][ 'module' ][ 'config' ][ 'items' ][] = array( 'Caddy Mini', 'caddymini', t3lib_extMgm::extRelPath( $_EXTKEY ) . 'files/img/caddy_050_03.png' );
    break;
  default:
    // English
    $TCA[ 'pages' ][ 'columns' ][ 'module' ][ 'config' ][ 'items' ][] = array( 'Caddy', 'caddy', t3lib_extMgm::extRelPath( $_EXTKEY ) . 'files/img/caddy_100_02.png' );
