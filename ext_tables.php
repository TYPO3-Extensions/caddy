...
switch ( true )
{
  case( $beLanguage == 'de' ):
    ...
    t3lib_extMgm::addStaticFile( $_EXTKEY, $path2Ts . 'Foundation/4x/Css/', 'Caddy [3.1] + Foundation 4.x CSS (veraltet!' );
    ...
    t3lib_extMgm::addStaticFile( $_EXTKEY, $path2Ts . 'Powermail/2x/Bootstrap/3x/', 'Caddy [6] + Powermail 2.x Bootstrap' );
    t3lib_extMgm::addStaticFile( $_EXTKEY, $path2Ts . 'Powermail/2x/Foundation/5x/', 'Caddy [6] + Powermail 2.x Foundation' );
