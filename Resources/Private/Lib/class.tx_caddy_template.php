...
class tx_caddy_template
{
    ...
    public $scriptRelPath = 'Resources/Private/Lib/class.tx_caddy_template.php';
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/caddy/Resources/Private/Lib/class.tx_caddy_template.php'])
{
  include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/caddy/Resources/Private/Lib/class.tx_caddy_template.php']);
}
?>