...
//    foreach( ( array ) $sesArray['options']['specials']['ids'] as $key )
  ...
  private function initEpaymentMethods()
  {
    ...
    $path2provider = t3lib_extMgm::extPath( 'caddy' ) . 'Resources/Private/Lib/e-payment/' . $provider . '/class.tx_caddy_' . $provider . '_paymentMethods.php';
...
if ( defined( 'TYPO3_MODE' ) && $TYPO3_CONF_VARS[ TYPO3_MODE ][ 'XCLASS' ][ 'ext/caddy/Resources/Private/Lib/caddy/class.tx_caddy.php' ] )
{
  include_once($TYPO3_CONF_VARS[ TYPO3_MODE ][ 'XCLASS' ][ 'ext/caddy/Resources/Private/Lib/caddy/class.tx_caddy.php' ]);
}
?>
