...
class tx_caddy_paymill_lib extends tslib_pibase
{
    ...
    public $scriptRelPath = 'Resources/Private/Lib/e-payment/paymill/class.tx_caddy_paymill_lib.php';
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/caddy/Resources/Private/Lib/e-payment/paymill/class.tx_caddy_paymill_lib.php'])
{
  include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/caddy/Resources/Private/Lib/e-payment/paymill/class.tx_caddy_paymill_lib.php']);
}
?>