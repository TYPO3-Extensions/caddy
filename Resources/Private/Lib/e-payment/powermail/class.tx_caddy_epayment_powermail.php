...
class tx_caddy_epayment_powermail extends tslib_pibase
{
  ...
  public $scriptRelPath = 'Resources/Private/Lib/e-payment/powermail/class.tx_caddy_epayment_powermail.php';
...
//var_dump( __FILE__, __LINE__, $arrReturn );
  ...
  {
    $path2provider = t3lib_extMgm::extPath( 'caddy' ) . 'Resources/Private/Lib/e-payment/paymill/class.tx_caddy_paymill_transaction.php';
...
if ( defined( 'TYPO3_MODE' ) && $TYPO3_CONF_VARS[ TYPO3_MODE ][ 'XCLASS' ][ 'ext/caddy/Resources/Private/Lib/e-payment/powermail/class.tx_caddy_epayment_powermail.php' ] )
{
  include_once($TYPO3_CONF_VARS[ TYPO3_MODE ][ 'XCLASS' ][ 'ext/caddy/Resources/Private/Lib/e-payment/powermail/class.tx_caddy_epayment_powermail.php' ]);
}
?>