...
class tx_caddy_fancybox
{
  ...
  * @var string
  */
  public $scriptRelPath = 'Resources/Private/Lib/jquery/class.tx_caddy_fancybox.php';
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/caddy/Resources/Private/Lib/jquery/class.tx_caddy_fancybox.php'])
{
  include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/caddy/Resources/Private/Lib/jquery/class.tx_caddy_fancybox.php']);
}
